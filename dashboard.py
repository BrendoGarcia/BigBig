...
@st.cache_data
def load_data():
    df = pd.read_csv("ProjetoDash/processed_data.csv")
    return df
...
if page == "Dashboard Principal":
    ...
    correlations = df[["ideb","rede","indicador_rendimento","nota_saeb_media_padronizada","nivel_socioeconomico", "taxa_evasao_historica", "alta_evasao"]].corr()["alta_evasao"].abs().sort_values(ascending=False)
